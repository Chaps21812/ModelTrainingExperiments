...
if __name__ == "__main__":
    ...
    M1 = "/data/Dataset_Compilation_and_Statistics/Sentinel_Datasets/models/Production-LMNT01-2025-Annotations_2025-11-11_07:55/Production-LMNT01-2025-Annotations_weights_E53.pt"
    M2 = "/data/Dataset_Compilation_and_Statistics/Sentinel_Datasets/models/Production-LMNT02-2025-Annotations_2025-11-11_07:55/Production-LMNT02-2025-Annotations_weights_E90.pt"
    M3 = "/data/Dataset_Compilation_and_Statistics/Sentinel_Datasets/models/Production-RME01-2025-Annotations_2025-11-11_12:46/Production-RME01-2025-Annotations_weights_E53.pt"
    M4 = "/data/Dataset_Compilation_and_Statistics/Sentinel_Datasets/models/Production-RME04-2025-Annotations_2025-11-11_07:54/Production-RME04-2025-Annotations_weights_E64.pt"
    M5 = "/data/Dataset_Compilation_and_Statistics/Sentinel_Datasets/models/Production-ABQ01-2025-Annotations_2025-11-12_11:07/Production-ABQ01-2025-Annotations_weights_E46.pt"
    M6 = "/data/Dataset_Compilation_and_Statistics/Sentinel_Datasets/models/Production-SatNet1.4_2025-11-13_07:29/Production-SatNet1.4_weights_E57.pt"
    M7 = "/data/Dataset_Compilation_and_Statistics/Sentinel_Datasets/models/Production-All_Data_2025-11-11_07:49/Production-All_Data_weights_E15.pt"
    M8 = "/data/Dataset_Compilation_and_Statistics/Sentinel_Datasets/models/Production-NoRescale_Training_2025-11-18_08:20/Production-NoRescale_Training_weights_E10.pt"
    M9 = "/data/Dataset_Compilation_and_Statistics/Sentinel_Datasets/models/Production-LMNT-Holdout_2025-11-13_07:31/Production-LMNT-Holdout_weights_E15.pt"
    M10 = "/data/Dataset_Compilation_and_Statistics/Sentinel_Datasets/models/Production-100kLimited_2025-11-17_08:02/Production-100kLimited_weights_E10.pt"
    ...
    D5 = "/data/Dataset_Compilation_and_Statistics/Sentinel_Datasets/SatNet1.4/test"
    ...
    for model, dataset in itertools.product(models,datasets):
        ...
        evaluation_params = {
            ...
            "run_name": f"Prod_Auto_Eval_{os.path.basename(model)}_{os.path.basename(dataset)}_{datetime.now().strftime('%Y-%m-%d_%H:%M')}",
            "model": model,
            "dataset": dataset,
            "device_no": 1,
