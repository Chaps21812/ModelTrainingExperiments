...
if __name__ == "__main__":
    ...
    # Datasets
    LMNT01dataset = "/data/Dataset_Compilation_and_Statistics/Sentinel_Datasets/Finalized_datasets/LMNT01_LargeTrainDemo/test"
    RME04dataset = "/data/Dataset_Compilation_and_Statistics/Sentinel_Datasets/Finalized_datasets/RME04_2025/test"
    RME01dataset = "/data/Dataset_Compilation_and_Statistics/Sentinel_Datasets/Finalized_datasets/RME01_2025/test"

    #Set the parameters of your evaluation here
    evaluation_params = {
        "experiment":"SentinelDemo",
        "run_name": f"Recentroid-R4Small-{datetime.now().strftime('%Y-%m-%d_%H:%M')}",
        "model": RME04_249,
        "dataset": LMNT01dataset,
        "device_no": 2,
        "architecture_type":"SentinelNMS" #Sentinel, SentinelNMS, Panoptic_Sentinel, 
        }
