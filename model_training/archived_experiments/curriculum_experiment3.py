...
if __name__ == "__main__":
    ...
    training_sets = ["/data/Dataset_Compilation_and_Statistics/Sentinel_Datasets/Finalized_datasets/Curriculum_L1_High_SNR_TTS/train","/data/Dataset_Compilation_and_Statistics/Sentinel_Datasets/Finalized_datasets/Curriculum_L1_Low_SNR_TTS/train"]
    ...
    train_params = {
        ...
        "experiment_name": f"RHL-BS{switch_every}",
