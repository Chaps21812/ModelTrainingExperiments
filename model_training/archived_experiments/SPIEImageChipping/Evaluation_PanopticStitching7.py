...
if __name__ == "__main__":
    ...
    L1_10Overlap_model = "/data/Dataset_Compilation_and_Statistics/Sentinel_Datasets/Finalized_datasets/Panoptic_MC_LMNT01_train_10_Overlap/models/L1_10_Overlap_2025-08-22_05:11/L1_10_Overlap_weights_E85.pt"
    L1_20Overlap_model = "/data/Dataset_Compilation_and_Statistics/Sentinel_Datasets/Finalized_datasets/Panoptic_MC_LMNT01_train_20_Overlap/models/L1_20_Overlap_2025-08-22_05:11/L1_20_Overlap_weights_E29.pt"
    L1_30Overlap_model = "/data/Dataset_Compilation_and_Statistics/Sentinel_Datasets/Finalized_datasets/Panoptic_MC_LMNT01_train_30_Overlap/models/L1_30_Overlap_2025-08-22_05:07/L1_30_Overlap_weights_E30.pt"
    L1_Random_Overlap_model = "/data/Dataset_Compilation_and_Statistics/Sentinel_Datasets/Finalized_datasets/Panoptic_MC_LMNT01_train_random_Overlap/models/L1_R_Overlap_2025-08-22_05:06/L1_R_Overlap_weights_E50.pt"
    L2_Random_Overlap_model = "/data/Dataset_Compilation_and_Statistics/Sentinel_Datasets/Finalized_datasets/Panoptic_MC_LMNT02_train_random_overlap/models/L2_R_Overlap_2025-08-21_12:19/L2_R_Overlap_weights_E44.pt"
    R4_Random_Overlap_model = "/data/Dataset_Compilation_and_Statistics/Sentinel_Datasets/Finalized_datasets/Panoptic_MC_RME04_train_random_overlap/models/R4_R_Overlap_2025-08-21_03:57/R4_R_Overlap_weights_E52.pt"
    L1_Normal_model= "/data/Dataset_Compilation_and_Statistics/Sentinel_Datasets/Finalized_datasets/No_Chipping_LMNT01_dataset/models/No_Chipping_LMNT01_2025-08-25_10:22/No_Chipping_LMNT01_weights_E22.pt"
    L2_Normal_model= "/data/Dataset_Compilation_and_Statistics/Sentinel_Datasets/Finalized_datasets/No_Chipping_LMNT02_dataset/models/No_Chipping_LMNT02_2025-08-21_03:56/No_Chipping_LMNT02_weights_E19.pt"
    R4_Normal_model= "/data/Dataset_Compilation_and_Statistics/Sentinel_Datasets/Finalized_datasets/No_Chipping_RME04_dataset/models/No_Chipping_RME04_2025-08-22_05:01/No_Chipping_RME04_weights_E17.pt"
    ...
    evaluation_params = {
        ...
        "run_name": f"Evaluation_L1-NoChip_{datetime.now().strftime('%Y-%m-%d_%H:%M')}",
        "model": L1_Normal_model,
        "dataset": L1_dataset,
        "device_no": 7,
