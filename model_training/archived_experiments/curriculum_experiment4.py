...
if __name__ == "__main__":
    ...
    training_sets = ["/data/Dataset_Compilation_and_Statistics/Sentinel_Datasets/Finalized_datasets/Curriculum_L1_TTS/train"]
    ...
    train_params = {
        ...
        "experiment_name": f"R100-BS{switch_every}",
