...
if __name__ == "__main__":
    ...
    # Dataset paths
    training_dir = "/mnt/c/Users/david.chaparro/Documents/data/MultiChannelRME04Sats_Train/train"
    validation_dir = "/mnt/c/Users/david.chaparro/Documents/data/MultiChannelRME04Sats_Train/val"
    ...
    training_loader = DataLoader(training_set, batch_size=5, shuffle=True, collate_fn=lambda x: (zip(*x)))
    validation_loader = DataLoader(validation_set, batch_size=5, shuffle=True, collate_fn=lambda x: (zip(*x)))

    # Load model
    model =  torchvision.models.detection.retinanet_resnet50_fpn()
    # num_classes = 2  # Include background as class 0
