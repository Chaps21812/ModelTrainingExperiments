...
if __name__ == "__main__":
    ...
    Panoptic_model = "/data/Dataset_Compilation_and_Statistics/Sentinel_Datasets/Finalized_datasets/SatsimMCTrain/models/Satsim/retinanet_weights_E76.pt"
    ...
    run_name = f"PanopticSim_on_L1_Data"
