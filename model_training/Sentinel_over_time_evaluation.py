...
if __name__ == "__main__":
    ...
    title = "Sentinel_Over_time_L2_Model_On_L2_Data"
    ...
    database = perform_timewise_benchmark(LNT02_Evaluation_set, LMNT02model, output_dir, title, metrics, device_no=device_no)
    database = perform_cumulative_evaluation(LNT02_Evaluation_set, LMNT02model, output_dir, title, metrics, device_no=device_no, database=database)
