...
if __name__ == "__main__":
    ...
    train_params = {
        ...
        "model_path": None,
        "training_dir": ["/data/Sentinel_Datasets/Finalized_datasets/LMNT02Sat_Training_Channel_Mixture_C/train","/data/Sentinel_Datasets/Finalized_datasets/LMNT01Sat_Training_Channel_Mixture_C/train","/home/davidchaparro/Repos/Dataset_Compilation_and_Statistics/data_finalized/RME04_MixtureC_Final/RME04Sat_Training_Channel_Mixture_C/train", "/home/davidchaparro/Repos/Dataset_Compilation_and_Statistics/data_finalized/satsim_sats_dataset"],
        ...
        "momentum": 0.9,
        "weight_decay": 0.0005, 
        "experiment_name": "Image_Stitching_LMNT01_All_Real+Simulated", 
        "sub_batch_size": 40
    }
