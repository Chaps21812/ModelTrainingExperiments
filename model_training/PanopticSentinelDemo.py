...
def perform_timewise_benchmark(datasets:list, model_path:str, output_directory:str, experiment_title, evaluation_metrics, device_no=5, database=None, batchsize=10):
    ...
    model = Sentinel_Panoptic(normalize=False, sub_batch_size=batchsize, save_image="/data/Dataset_Compilation_and_Statistics/Sentinel_Datasets/Plots/DemoDay")
...
if __name__ == "__main__":
    ...
    LMNT01_Evaluation_set = ["/data/Dataset_Compilation_and_Statistics/Sentinel_Datasets/Finalized_datasets/LMNT01Sat-2024-09-13_Channel_Mixture_C_Eval"
    ]
