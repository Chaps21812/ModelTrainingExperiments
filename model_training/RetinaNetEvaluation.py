...
if __name__ == "__main__":
    ...
    bruh_dataset = "/data/Dataset_Compilation_and_Statistics/Sentinel_Datasets/Finalized_datasets/CL_L1/test"
    ...
    evaluation_params = {
        "experiment":"TEsting",
        "run_name": f"Evaluation_Testing_{datetime.now().strftime('%Y-%m-%d_%H:%M')}",
        "model": SR1Model,
